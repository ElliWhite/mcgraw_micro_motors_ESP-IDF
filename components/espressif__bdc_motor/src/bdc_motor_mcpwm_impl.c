...
//#include "components/espressif__bdc_motor/interface/bdc_motor.h"
...
static esp_err_t bdc_motor_mcpwm_brake(bdc_motor_t *motor)
{
    ...
    ESP_RETURN_ON_ERROR(mcpwm_generator_set_force_level(mcpwm_motor->genb, 1, true), TAG, "set force levelmotor_config for genb failed");
    return ESP_OK;
}
